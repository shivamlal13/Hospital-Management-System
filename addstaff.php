          ...
          body 
            {
              font-family: Arial;
              font-size: 16px;
                background-image: url(images/addstaff.jpg);
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="list-group">
                        <div class="list-group-item" style="background-color:rgba(1, 132, 255,0.8);border-radius:10px; text-align:center;"><h4 style="color:#ffffff">Add Staff Members</h4></div>
                        <div class="list-group-item" style="margin-bottom:80px;background-color:rgba(184, 184, 185,0.1);border: 1px solid #0B98FA;">        
                            ...
                            <form action="func.php" method="post" class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" id="idd" name="eid" style="height:30px;" autocomplete="off">
                                    ...
                                    <div class="col-md-3">
                                        <input type="date" name="edate" style="border:1px solid #0079EB;border-radius:5px;">
                                    </div>                
                                </div>
                                <div id="id_error" class="error"></div>
                                <label> Full Name</label>
                                    <input type="text" class="form-control" id="name" placeholder="Shivam Lal" autocomplete="off" name="ename">
                                <div id="name_error" class="error"></div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" class="form-control" id="aage" name="eage" autocomplete="off" style="height:30px;">
                                            </div>
                                            <div class="col-md-1"></div>
                                            <div class="col-md-2">
                                                <label>Sex</label>
                                ...
                                <label> Address</label>
                                    <input type="text" id="address" class="form-control" placeholder="Patna" autocomplete="off" name="eaddress">
                                <div id="address_error" class="error"></div>
                                <label>Contact</label>
                                    <input type="text" class="form-control" id="contact" placeholder="Contact" autocomplete="off" name="econtact">
                                <div id="contact_error" class="error"></div>
                                <label> Email</label>
                                    <input type="email" id="email" class="form-control" placeholder="xyz@gmail.com" autocomplete="off" name="eemail">
                                <div id="email_error" class="error"></div>
                                <label>Designation</label>
                                <select name="designation">
                                    <option value="Manager">Manager</option>
                                    <option value="Deputy Manager">Deputy Manager</option>
                                    <option value="Sn. Doctor">Sn. Doctor</option>
                                    <option value="Asst. Docter">Asst. Doctor</option>
                                ...
                                <input type="submit" class="btn btn-primary" id="submit" name="pat3_submit" value="Enter Details" style="width:100%; height:50px;">
                            </form>
                        </div>  
                    </div>
                </div>
